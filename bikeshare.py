...
def time_stats(df):
    ...
    print('Most common day of week: {}'.format(df['weekday_name'].mode()[0]))
...
def station_stats(df):
    ...
    print('Most common combination of start station and end station trip: {}'.format(df['Start End Station'].mode()[0]))
...
def trip_duration_stats(df):
    ...
    print('Total travel time: {}'.format(df['time'].sum()))

    # display mean travel time
    print('Mean travel time: {}'.format(df['time'].mean()))
